...
**Версия 2.1 — «ярко, контрастно, без розового»:** шрифт Ubuntu, чёрный, белый и фирменный зелёный `#00BD00`. У каждой из 9 целей свой чистый цвет и своя анимация по смыслу слова: у Краси — сияние, у Енергії — молния, у Сну — месяц и звёзды, у Імунітету — щит, у Балансу — камни дзен, у Довголіття — годичные кольца, у Детоксу — пузырьки, у Вітамінів — капсулы, у «Для очей» — глаз.
...
<img src="readme/goals-phone.jpg" width="300" alt="Плитки целей на телефоне"> <img src="readme/goal-page-phone.jpg" width="300" alt="Страница цели «Сон» на телефоне">

## Что можно посмотреть

- главную: видео с сакурой и белые лепестки поверх него, 9 цветных плиток целей с анимациями, бестселлеры, философию, новинки, подбор «Знайдіть своє IKIGAI», бренды, журнал, вопросы;
- страницы целей (например, «Сон»): вверху большая плитка цели с её анимацией, ниже товары;
- салют лепестков в цвете цели товара при добавлении в корзину и разноцветный салют после заказа;
